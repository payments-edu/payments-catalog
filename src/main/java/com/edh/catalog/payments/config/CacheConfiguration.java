package com.edh.catalog.payments.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("paymentscatalog");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("paymentscatalog");
        ...
        config.getMapConfigs().put("com.edh.catalog.payments.domain.*", initializeDomainMapConfig(jHipsterProperties));
